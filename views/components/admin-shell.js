    ...
    <main className="relative min-h-screen overflow-x-hidden bg-[#04101d] px-3 py-3 sm:px-4 sm:py-4">
      ...
      <div className="relative z-10">
        ...
        <button
          ...
          className="fixed bottom-20 right-4 z-[9998] flex lg:hidden h-12 w-12 flex-col items-center justify-center gap-1 rounded-full bg-[#1a3a5c] shadow-[0_4px_20px_rgba(26,58,92,0.5)] transition hover:bg-[#1e4a72]"
